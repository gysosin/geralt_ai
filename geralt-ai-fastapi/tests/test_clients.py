...
class TestElasticsearchClient:
    ...
    def es_client(self, mock_es):
        ...
        with patch('core.clients.elasticsearch_client.AsyncElasticsearch', return_value=mock_es):
    ...
    @pytest.mark.asyncio
    async def test_ping_success(self, es_client, mock_es):
        """Test successful ping."""
        result = await es_client.ping()
        mock_es.ping.assert_awaited()
        assert result is True

    @pytest.mark.asyncio
    async def test_ping_failure(self, es_client, mock_es):
        """Test ping failure."""
