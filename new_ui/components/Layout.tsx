      ...
      <div className="flex-1 flex flex-col h-full relative overflow-hidden bg-[#09090b]">
        ...
        <header className="hidden md:flex h-20 items-center justify-between px-8 z-20">
          ...
          <div className="flex items-center gap-4">
             ...
             <button className="relative p-2.5 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
               <Bell size={20} />
